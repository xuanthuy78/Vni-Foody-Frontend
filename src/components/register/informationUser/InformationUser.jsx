    ...
    return (
        <div className="information-bottom">
           <div className="information-tilte">
               <h2><span className="title">Thông tin cá nhân</span></h2>
          </div>
          <form className="form-inlineng-pristine" >
             ...
             <div className="form-group">
                ...
                <div className="col-xl-9 col-lg-9 col-md-9 col-sm-9 col-9">
                    <select className="form-control " ng-model="DistrictId" ng-options="item.Id as item.Name for item in Districts">
