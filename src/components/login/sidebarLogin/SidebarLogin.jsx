...
export class SidebarLogin extends Component {
  render() {
    return (
       ...
       <h3 className="title">
        ...
        <ul className="nav nav-pills flex-column menu-main">
            <li className="nav-item"><Link className="nav-link" to="#"><i className="fa fa-sign-out" aria-hidden="true"></i> Đăng nhập </Link>
            </li>
            <li className="nav-item"><Link className="nav-link" to="#"><i className="fa fa-key" > </i> Đăng ký</Link> </li>
