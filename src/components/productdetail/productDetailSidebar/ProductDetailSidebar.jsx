  ...
  render() {
    return (
      <div className="productdetail-sidebar">
         <div>
         <h3 className="title"><span >CHÍNH SÁCH BÁN HÀNG</span></h3>
         ...
         <h3 className="title">Hướng Dẫn Mua Hàng</h3>
            <ul>
              ...
              <li>
                Gọi điện thoại <strong className="ng-binding">
                  0908770095
                </strong> để mua hàng
              </li>
              <li>
                Mua tại Trung tâm CSKH:<br />
                <strong className="ng-binding">5/12A Quang Trung, P.14, Q.Gò Vấp, Tp.Hồ Chí Minh</strong>
                <Link href="/ban-do.html" rel="nofollow" target="_blank"className="map" > Xem Bản Đồ</Link>
              </li>
              <li>
                Mua sỉ/buôn xin gọi <strong className="ng-binding">
                  0908770095
                </strong> để được
                hỗ trợ.
              </li>
